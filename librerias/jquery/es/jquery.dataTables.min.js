...
fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activar para ordenar columna ascendientemente",sSortDescending:": activar para ordenar columna descendientemente"},oPaginate:{sFirst:"Primero",sLast:"&Uacute;ltimo",sNext:"Pr&oacute;ximo",sPrevious:"Previo"},
sEmptyTable:"Informaci&oacute;n no disponible en la tabla",sInfo:"Mostrando _START_ hasta _END_ de _TOTAL_ entradas",sInfoEmpty:"Mostrando 0 hasta 0 de 0 entradas",sInfoFiltered:"(filtrado de un total de _MAX_ entradas)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Muestra _MENU_ entradas",sLoadingRecords:"Cargando...",sProcessing:"Procesando...",sSearch:"Busqueda:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No se han encontrado registros"},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",
...
sSortIcon:"DataTables_sort_icon",sScrollHead:"dataTables_scrollHead "+E,sScrollFoot:"dataTables_scrollFoot "+E,sHeaderTH:E,sFooterTH:E,sJUIHeader:Ub+" ui-corner-tl ui-corner-tr",sJUIFooter:Ub+" ui-corner-bl ui-corner-br"});var Lb=p.ext.pager;h.extend(Lb,{simple:function(){return["previo","pr&oacute;ximo"]},full:function(){return["primero","previo","pr&oacute;ximo","&uacute;ltimo"]},simple_numbers:function(a,b){return["previo",Ua(a,b),"pr&oacute;ximo"]},full_numbers:function(a,b){return["first","previo",Ua(a,b),"pr&oacute;ximo","&uacute;ltimo"]},_numbers:Ua,
numbers_length:7});h.extend(!0,p.ext.renderer,{pageButton:{_:function(a,b,c,d,e,f){var g=a.oClasses,j=a.oLanguage.oPaginate,i,l,m=0,o=function(b,d){var k,p,r,q,s=function(b){Ra(a,b.data.action,true)};k=0;for(p=d.length;k<p;k++){q=d[k];if(h.isArray(q)){r=h("<"+(q.DT_el||"div")+"/>").appendTo(b);o(r,q)}else{l=i="";switch(q){case "ellipsis":b.append("<span>&hellip;</span>");break;case "primero":i=j.sFirst;l=q+(e>0?"":" "+g.sPageButtonDisabled);break;case "previo":i=j.sPrevious;l=q+(e>0?"":" "+g.sPageButtonDisabled);
break;case "pr&oacute;ximo":i=j.sNext;l=q+(e<f-1?"":" "+g.sPageButtonDisabled);break;case "&uacute;ltimo":i=j.sLast;l=q+(e<f-1?"":" "+g.sPageButtonDisabled);break;default:i=q+1;l=e===q?g.sPageButtonActive:""}if(i){r=h("<a>",{"class":g.sPageButton+" "+l,"aria-controls":a.sTableId,"data-dt-idx":m,tabindex:a.iTabIndex,id:c===0&&typeof q==="string"?a.sTableId+"_"+q:null}).html(i).appendTo(b);Ta(r,{action:q},s);m++}}}};try{var k=h(O.activeElement).data("dt-idx");o(h(b).empty(),d);k!==null&&h(b).find("[data-dt-idx="+k+"]").focus()}catch(p){}}}});
